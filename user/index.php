...
// Fetch products based on filter/search
...
// Hero Section
echo "<div style='text-align:center; padding:30px; background:#2980b9; color:white;'>
        <h1>Welcome to Electronics Store</h1>
        <p>Shop the latest gadgets and devices with ease!</p>
      </div>";
